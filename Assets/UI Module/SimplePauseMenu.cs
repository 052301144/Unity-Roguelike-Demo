...
public class SimplePauseMenu : MonoBehaviour
{
    ...
    public GameObject settingsPanel; // 新增：设置面板
    public Button menuButton;
    public Button resumeButton; // 返回游戏按钮
    public Button settingsButton; // 新增：设置按钮
    public Button mainMenuButton; // 返回主菜单按钮
    public Button backFromSettingsButton; // 新增：从设置返回按钮
    ...
    void FindResumeButton()
    {
        ...
        if (menuPanel != null)
        {
            ...
            {
                resumeButton.onClick.AddListener(ResumeGame);
                Debug.Log("自动找到返回游戏按钮: " + resumeButton.name);
            }
        }
    }
