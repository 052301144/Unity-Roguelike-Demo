...
public class DebugTest : MonoBehaviour
{
    ...
    private void RegisterEvents()
    {
        ...
        playerAttr.OnTakeDamage += (damage, attacker) =>
            Debug.Log($"玩家受到伤害: {damage}点 (来自: {attacker?.name})");
        ...
        enemyAttr.OnTakeDamage += (damage, attacker) =>
            Debug.Log($"敌人受到伤害: {damage}点 (来自: {attacker?.name})");
    ...
    private IEnumerator TestHealing()
    {
        ...
        Debug.Log($"敌人受伤后生命值: {enemyAttr.CurrentHealth}");
